...
function Intro() {
  return (
    ...
    pb-6">
      ...
      <p className="columns-auto text-m max-w-xl mb-6 font-bold"> I'm an Audio Engineer, Artist, and Musican by hobby, and in my professional career, I've spent the last 10 years working with IT Systems and have begun moving into software development.
