		...
		<motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
			...
			>
				...
				<div className='mt-5'>
					...
					<h4 className='justify-between flex'>
						<div>{image_link && <a href={image_link}>Demo</a>} </div>
						<div>
	...
	return (
		<>
			...
			<div className='w-full flex'>
				...
				>
					The Following projects showcase my skills and experience with
					real-world examples of both my personal and professional work.
				</motion.p>
			</div>
